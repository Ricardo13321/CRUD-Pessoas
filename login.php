...
<body>
    <center><h2><b>LOGIN</h2></b></h2></center>
    <hr><br><br>
    <div class="row justify-content-center row-cols-1 row-cols-md-3 text-center">
        <div class="cols">
            <div class="card mb-4 rounded shadow-sw">
                ...
                <div class="card-body">
                    <form action="autenticacao.php" method="post" class="text-start">
                        ...
                        <br>
                        <input class="btn btn-purple" style="font-weight: bolder;" type="submit" value="ENTRAR">
                        <button type="button" class="btn btn-purple" data-bs-toggle="modal" data-bs-target="#exampleModal"><b>CADASTRAR</b></button>
                    </form>
                </div>
            </div>
        </div>
